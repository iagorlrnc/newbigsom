...
export default function Booking() {
  ...
  useEffect(() => {
    ...
    // Bloqueia acesso ao agendamento para administradores
    if (isAdmin) {
      navigate("/admin")
      return
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedDate || !selectedTime || !service) {
      alert(
        "Por favor, preencha todos os campos obrigatórios (Data, Horário, Serviço).",
      )
      return
    }
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="text-zinc-400 hover:text-red-400 flex items-center gap-2"
          >
            Sair <LogOut size={16} />
          </button>
        </div>
        ...
        <div className="bg-zinc-900 shadow rounded-lg px-8 py-10 border border-zinc-800">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 md:gap-0">
            <h2 className="text-3xl font-bold">
              Solicitar <span className="text-neon">Orçamento</span>
            </h2>
          ...
          <p className="text-zinc-400 mb-8 -mt-6">
            Escolha a melhor data e horário para trazer seu veículo até nós.
          </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Acessórios e Módulos">
                    Acessórios e Módulos
                  </option>
                  <option value="Insulfilm">Insulfilm</option>
                  <option value="Personalização e LED">
                    Personalização e LED
                  </option>
